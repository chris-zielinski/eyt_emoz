...
datopt = [];
datopt.fixpath = [datapath, filesep, 'export_tobii', filesep, 'Emo*T0*P*.tsv'];
datopt.critpath = [datapath, filesep, 'critical_times.txt'];
datopt.normpath = [datapath, filesep, 'norming_auditive.txt'];
datopt.freqpath = [datapath, filesep, 'speech_f0_slope.txt'];
dataopt.output = make_dir('output');
...
save([dataopt.output, filesep, 'emoz_time_analysis.mat'], 'Sdat', 'Sta', 'Spatchw');
...
figopt.savepath = dataopt.output;
