function Sdat = emoz_timeanalysis_extract_debug(datopt)
% Extract, align & gather data per conditions
% -- Read Tobii data file 
% -- Gather data together in a same struct Sdat
...
for id = 1 : Nfile
    ...
    % (maybe missing in the previous preprocessing of 1st part)
